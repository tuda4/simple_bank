...
// Source: github.com/tuda4/simple_bank/db/sqlc (interfaces: Store)
...
func (m *MockStore) CreateTransfer(arg0 context.Context, arg1 db.CreateTransferParams) (db.Tranfer, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateTransfer", arg0, arg1)
	ret0, _ := ret[0].(db.Tranfer)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockStore) GetTransfer(arg0 context.Context, arg1 int64) (db.Tranfer, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) ListTransfers(arg0 context.Context, arg1 db.ListTransfersParams) ([]db.Tranfer, error) {
	m.ctrl.T.Helper()
